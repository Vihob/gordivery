/*
 Dependencies:
  ...
  - utils.js
*/
var officeDetail1Controller = function (){
    ...
    var viewLoaded = function(){
      ...
      L.loadLiterals(function(){
        ...
        officeDetail1Controller.viewWillAppear();
    ...
    var viewWillAppear = function(){
      ...
      //Get office info with index 0
      restConsumer.getOfficeInfo(onGetOffice, onGetOfficeError, 0);
    }
    ...
    */
    ...
    function saveStoredInfo(data){
      localStorage.setItem( k_OFFICES1_STORED_DATA_KEY, JSON.stringify( data ));
    }

    function loadStoredInfo(){

      var storedData = utils.retriveJSONParseWithLocalStorageKey( k_OFFICES1_STORED_DATA_KEY );
      if (storedData) {
